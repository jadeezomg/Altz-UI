...
local mediaPath = "Interface\\AddOns\\Aurora\\media\\"
...
C.media = {
	...
	["bgTex"] = "Interface\\Addons\\Aurora\\media\\bgTex",
	["glowTex"] = "Interface\\Addons\\Aurora\\media\\glowTex",
}
...
--	slider:SetTexture("Interface\\CastingBar\\UI-CastingBar-Spark.blp")
...
Skin:SetScript("OnEvent", function(_, _, addon)
	...
	if addon == "Aurora" then
		...
		local bds = {"TicketStatusFrameButton", "RaidInfoFrame", "ScrollOfResurrectionSelectionFrame", "ScrollOfResurrectionFrame", "VoiceChatTalkers", "ReportCheatingDialog"}
